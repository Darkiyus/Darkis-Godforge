...
The compiled `scripts/main.js` is intentionally versioned because Foundry installs the repository contents directly. Run `npm run check` before committing source changes to keep the bundle synchronized.
