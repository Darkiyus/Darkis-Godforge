...
var $e = (s, e, t) => e in s ? We(s, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : s[e] = t;
var f = (s, e, t) => $e(s, typeof e != "symbol" ? e + "" : e, t);
function Ne(s, e) {
  return {
    name: s.name,
    type: "deity",
    ...
    system: {
      ...
      sanctification: Ke(s.sanctification),
...
async function le(s) {
  var r, n, a, o, l, c, d, u;
  const t = (((n = (r = S()) == null ? void 0 : r.packs) == null ? void 0 : n.contents) ?? []).filter((p) => {
    var h;
  ...
  for (const p of t) {
    ...
    for (const m of h) {
      ...
      const A = `Compendium.${p.collection}.Item.${m._id}`, b = Array.isArray((a = m.system) == null ? void 0 : a.domains) ? m.system.domains : [...((l = (o = m.system) == null ? void 0 : o.domains) == null ? void 0 : l.primary) ?? [], ...((d = (c = m.system) == null ? void 0 : c.domains) == null ? void 0 : d.alternate) ?? []];
      i.push({ id: A, sourceUuid: A, official: !0, name: m.name, title: m.name, image: m.img, domains: b, alignment: (u = m.system) == null ? void 0 : u.alignment });
    }
  }
  return i;
}
...
class ze {
  constructor() {
    f(this, "id", "pf2e");
    f(this, "capabilities", { lore: !0, deity: !0, passiveBonuses: !0, abilities: !0, classCoupling: !0, selectors: ["perception", "stealth", "deception", "ac", "attack-roll"] });
  }
...
class ce {
  constructor() {
    ...
    this.register(new ze()), this.register(new Je()), this.register(new Xe());
  }
  register(e) {
...
function U(s, e) {
  return e.isGM ? !0 : s.status === "published" && v(s.visibility.deity, s.id, e);
}
function F(s, e) {
  if (!U(s, e)) return null;
  const t = s.visibility.fields, i = { id: s.id, name: s.name, title: s.title };
  return v(t.portrait, s.id, e) && (i.image = s.image), v(t.description, s.id, e) && (i.description = s.description), v(t.quote, s.id, e) && (i.quote = s.quote), v(t.pantheon, s.id, e) && (i.pantheonIds = structuredClone(s.pantheonIds ?? [])), v(t.domains, s.id, e) && (i.domains = structuredClone(s.domains), i.alternateDomains = structuredClone(s.alternateDomains ?? [])), v(t.spells, s.id, e) && (i.spells = structuredClone(s.spells ?? {})), v(t.favoredWeapon, s.id, e) && (i.favoredWeapon = s.favoredWeapon), v(t.edicts, s.id, e) && (i.edicts = structuredClone(s.edicts ?? [])), v(t.anathema, s.id, e) && (i.anathema = structuredClone(s.anathema ?? [])), v(t.bonuses, s.id, e) && (i.passiveBonuses = s.passiveBonuses.filter((r) => r.enabled !== !1 && v(r.visibility ?? "followers", s.id, e)).map((r) => Qe(r, v(t.numericValues, s.id, e)))), v(t.abilities, s.id, e) && (i.abilities = s.abilities.filter((r) => r.enabled !== !1 && v(r.visibility ?? "followers", s.id, e)).map((r) => Ze(r, v(t.numericValues, s.id, e)))), i;
}
function Qe(s, e) {
...
function x(s, e) {
  ...
  return i.flatMap((a) => {
    ...
    return o && "mode" in o ? x(o, t) : o ? [o.ref] : [];
  });
}
function Ce(s, e) {
  return s.used < s.max;
...
function de(s) {
  ...
  try {
    return new Ge(ke(i), { actor: { level: 0 }, target: {} }).parse(), !0;
  } catch {
    return !1;
  }
}
...
function q(s, e) {
  ...
  if (s.type === "not") return !q(s.child, e);
  const t = s.children.map((i) => q(i, e));
...
async function lt(s, e) {
  ...
  if (s.condition && !q(s.condition, e.conditionFacts ?? {})) return t;
  for (const i of s.effects) await Le(i, e, t);
  return t;
}
async function Le(s, e, t) {
  ...
  if (s.type === "branch") {
    const r = q(s.condition, e.conditionFacts ?? {}) ? s.then : s.otherwise ?? [];
    for (const n of r) await Le(n, e, t);
    return;
  }
...
function Me(s) {
  ...
  if (t > O) throw new Error(`Unsupported deity schema ${t}.`);
  const i = [], r = e.visibility && typeof e.visibility == "object" ? e.visibility : {}, n = dt(r), a = ut(e.status, r.players), o = {
    ...e,
    schemaVersion: O,
    revision: Math.max(1, typeof e.revision == "number" ? e.revision : 0) + (t < O ? 1 : 0),
    createdAt: typeof e.createdAt == "string" ? e.createdAt : (/* @__PURE__ */ new Date()).toISOString(),
    updatedAt: t < O ? (/* @__PURE__ */ new Date()).toISOString() : String(e.updatedAt ?? (/* @__PURE__ */ new Date()).toISOString()),
  ...
  return t < O && i.push(`Legacy definition migrated to schema version ${O}.`), { definition: o, migrated: t < O, warnings: i };
}
function dt(s) {
  if (typeof s.deity == "string" && s.fields && typeof s.fields == "object") {
    const r = s.fields;
    return {
      deity: B(s.deity, G.deity),
      fields: Object.fromEntries(Object.entries(G.fields).map(([n, a]) => [n, B(r[n], a)]))
    };
  }
...
function ht(s) {
  ...
  const e = s;
  return { ...e, enabled: e.enabled !== !1, visibility: B(e.visibility, e.visible === !1 ? "gm" : "followers") };
}
function pt(s) {
  if (!s || typeof s != "object") return s;
  const e = s;
  return { ...e, enabled: e.enabled !== !1, visibility: B(e.visibility, "followers") };
}
function B(s, e) {
...
function Ue(s) {
  ...
  return s.deities.map((e) => Me(e).definition);
}
function ue(s, e) {
...
function Fe(s) {
  ...
  for (const n of t) {
    if (!J(n) || !_(n.id) || i.has(n.id) || !_(n.name) || !_(n.formula) || !ye(n.visibility) || !Array.isArray(n.entries) || !n.entries.length || !n.entries.every(Et)) return !1;
    i.add(n.id);
  }
  const r = /* @__PURE__ */ new Set();
  for (const n of e.wheels ?? []) {
    if (!J(n) || !_(n.id) || r.has(n.id) || !_(n.name) || !_(n.tableId) || !i.has(n.tableId) || !ye(n.visibility) || !Q(n.duration) || !Q(n.minimumSpins)) return !1;
    r.add(n.id);
  }
  return !0;
}
class Pe {
  ...
  load(e) {
    const t = e ?? {};
    if (!Fe(t)) throw new Error("Invalid GodForge random content.");
...
function R(s) {
  var n, a, o, l;
  const e = S(), t = (a = (n = e == null ? void 0 : e.settings) == null ? void 0 : n.get) == null ? void 0 : a.call(n, "darkis-godforge", "language");
  if (typeof t == "string" && t !== "auto") {
    const c = be(Z.get(t), s);
...
function pe() {
  var s, e;
  return ((e = (s = S()) == null ? void 0 : s.user) == null ? void 0 : e.isGM) === !0;
}
function me() {
  var s, e, t;
  (t = (e = (s = N()) == null ? void 0 : s.notifications) == null ? void 0 : e.warn) == null || t.call(e, R("DARKIS_GODFORGE.ERROR.GM_ONLY"));
}
function C(s = !1) {
  var r, n, a;
  const e = (r = S()) == null ? void 0 : r.user, t = e == null ? void 0 : e.character, i = (n = t == null ? void 0 : t.flags) == null ? void 0 : n["darkis-godforge"];
  return {
...
class Ve {
  ...
  async getSelectableDeities(e) {
    var h, m, A, b;
    const t = this.deities.list(), i = e.systemId ?? ((m = (h = S()) == null ? void 0 : h.system) == null ? void 0 : m.id) ?? "", r = C(!0), n = { classId: e.classId, level: e.level, region: e.region, pantheonFilter: e.pantheonFilter, systemId: i, catalogContext: e.catalogContext, viewer: r }, a = JSON.stringify([t.map((g) => [g.id, g.revision]), n]);
    if (((A = this.catalogCache) == null ? void 0 : A.key) === a) return this.catalogCache.result;
    const o = await (((b = this.adapters.tryGet(i)) == null ? void 0 : b.listOfficialDeities()) ?? Promise.resolve([])), l = e.catalogContext ?? "characterBuilder", c = new Set(t.filter((g) => g.replacement.sourceUuid && (g.replacement.mode === "hide" || g.replacement.mode === "replace") && (!g.replacement.contexts.length || g.replacement.contexts.includes(l))).map((g) => g.replacement.sourceUuid)), d = tt(t, e, /* @__PURE__ */ new Set(), r), u = o.filter((g) => !g.sourceUuid || !c.has(g.sourceUuid)), p = [...d, ...u];
    return this.catalogCache = { key: a, result: p }, p;
  }
  exportDeities(e) {
    return I(), mt(this.deities.list(), e);
  }
  importDeities(e) {
    I();
    const t = Ue(e);
  ...
  getCharacterWidgetData(e) {
    ...
    if (!r || !i) return Y(null, null);
    const n = C();
    if (n.isGM) return Y(r, i);
    const a = F(r, { ...n, actorDeityId: r.id, ownsActor: !0 });
    return Y(a, { ...i, grants: [] });
  }
  getGrantChoices(e, t) {
    var i;
    return I(), ((i = this.deities.get(e)) == null ? void 0 : i.grantGroups) ?? null;
  }
  ...
  async assignDeity(e, t, i = {}) {
    ...
    const n = Object.entries(i).map(([l, c]) => ({ groupId: l, refs: c })), a = r.grantGroups.flatMap((l) => x(l, n)), o = Object.fromEntries(r.abilities.filter((l) => l.uses).map((l) => [l.id, { used: 0, max: l.uses.max, lastResetAt: Date.now(), reset: l.uses.reset }]));
  ...
  async resetActorUsages(e, t) {
    I();
    const i = this.readState(e), r = Date.now(), n = Object.fromEntries(Object.entries(i.usages).map(([a, o]) => o.reset === t ? [a, st(o, r)] : [a, o]));
  ...
  async activateAbility(e, t, i = {}) {
    ...
    const o = r.usages[t];
    if (o && !Ce(o)) throw new Error("No uses remaining.");
    const l = o ? { ...r.usages, [t]: it(o) } : r.usages, c = { id: e.id, modifiers: {}, conditions: [] };
    await lt(a, { actor: c, target: i.target, facts: i.facts ?? { actor: { level: 0 }, target: {} }, rollDice: i.rollDice }), await e.update({ flags: { "darkis-godforge": { ...r, usages: l } } });
  }
  getReplacementFor(e) {
    return I(), this.deities.list().find((t) => t.replacement.sourceUuid === e && t.replacement.mode === "replace") ?? null;
  }
  isSourceHidden(e, t) {
    return I(), this.deities.list().some((i) => i.replacement.sourceUuid === e && i.replacement.mode === "hide" && i.replacement.contexts.includes(t));
  }
  registerAdapter(e) {
    I(), this.adapters.register(e);
  }
  async synchronizeActorDeityItem(e, t) {
    var l, c;
    const i = (c = (l = S()) == null ? void 0 : l.system) == null ? void 0 : c.id, r = i ? this.adapters.tryGet(i) : null;
...
function P(s, e) {
  var t, i, r;
  console.error(`Darkis GodForge | ${s}`, e), (r = (i = (t = N()) == null ? void 0 : t.notifications) == null ? void 0 : i.error) == null || r.call(i, R("DARKIS_GODFORGE.ERROR.ACTION_FAILED"));
}
function j(s, e = []) {
...
class ee extends $() {
  ...
  async _prepareContext() {
    this.tokens.clear();
    const t = this.deity.grantGroups.flatMap((n) => j(n)), i = /* @__PURE__ */ new Map(), r = t.map((n, a) => n.options.map((o, l) => {
  ...
  _onRender() {
    ...
    (r = (i = this.element) == null ? void 0 : i.querySelector("form")) == null || r.addEventListener("submit", (c) => {
      var p;
      c.preventDefault();
      const d = c.currentTarget, u = {};
      for (const [h, m] of this.groups.entries()) {
        if ((p = d.querySelector(`[data-choice-group='${h}']`)) != null && p.hidden) continue;
        const A = [...d.querySelectorAll(`[name='choice-${h}']:checked`)].flatMap((b) => {
          const g = this.tokens.get(b.value);
          return g ? [g] : [];
        });
        if (A.length !== m.pick) {
    ...
    const t = () => {
      ...
      (c = this.element) == null || c.querySelectorAll("[data-choice-group]").forEach((d) => {
        const p = [...d.querySelectorAll("[data-choice-requirement]")].every((h) => {
          ...
          return ((g = (b = this.element) == null ? void 0 : b.querySelector(`[name='${m}'][value='${A}']`)) == null ? void 0 : g.checked) === !0;
        });
...
class M extends $() {
  ...
  async _prepareContext() {
    var c, d, u, p, h, m, A;
    const t = ((c = this.preview) == null ? void 0 : c.viewer) ?? this.viewerOverride ?? C(!0), i = this.preview ? [{ ...this.preview.deity, status: "published" }] : this.deityService.list(), r = (p = (u = (d = this.actor) == null ? void 0 : d.flags) == null ? void 0 : u["darkis-godforge"]) == null ? void 0 : p.deityId, n = (h = S()) == null ? void 0 : h.user, a = !!(this.actor && n && ((A = (m = this.actor).testUserPermission) == null ? void 0 : A.call(m, n, "OWNER")) === !0), o = i.flatMap((b) => {
      const g = Se(b.grantGroups);
      if (t.isGM) return [{ ...b, image: L(b.image), selected: b.id === r, canSelect: !1, requiresChoices: g }];
      const E = F(b, t);
      return E ? [{ ...E, image: L(E.image), selected: b.id === r, canSelect: !!(this.api && this.socketRouter && this.actor && !this.preview && !this.viewerOverride && (t.ownsActor || a)), requiresChoices: g }] : [];
    }), l = o.filter((b) => {
      var g;
      return (!this.searchTerm || `${b.name} ${b.title ?? ""}`.toLocaleLowerCase().includes(this.searchTerm)) && (!this.selectedDomain || ((g = b.domains) == null ? void 0 : g.includes(this.selectedDomain)));
    });
    return { ui: w(), deities: l, domains: [...new Set(o.flatMap((b) => b.domains ?? []))].sort(), searchTerm: this.searchTerm, selectedDomain: this.selectedDomain, isGM: t.isGM, isPreview: !!(this.preview || this.viewerOverride) };
  }
  _onRender() {
    ...
    i && (i.value = this.searchTerm), r && (r.value = this.selectedDomain), i == null || i.addEventListener("input", (n) => {
      ...
      if (a) {
        ...
        this.socketRouter.assign({ actorId: this.actor.id, deityId: a.id, choices: {} }).then(() => this.render(!0)).catch((o) => P("Deity assignment failed.", o));
      }
    }));
  }
}
...
class H extends k() {
  ...
  async _prepareContext() {
    var r, n, a;
    I();
    const e = ((n = (r = S()) == null ? void 0 : r.system) == null ? void 0 : n.id) ?? "", t = ((a = this.adapters.tryGet(e)) == null ? void 0 : a.listSkills()) ?? [], i = w();
    return {
      ui: { ...i, NEW_DEITY: this.existing ? i.EDIT_DEITY : i.NEW_DEITY },
      selectors: t,
      visibilityFields: Ae.map((o) => ({ key: o, label: i[`VIS_FIELD_${o.replace(/([A-Z])/g, "_$1").toUpperCase()}`] ?? o })),
  ...
  _onRender() {
    ...
    e && t && this.existing && this.populateForm(e, t, this.existing), e == null || e.querySelectorAll("[data-action='browse-image']").forEach((l) => l.addEventListener("click", () => this.openFilePicker(e, l))), e == null || e.querySelectorAll("[data-image-field]").forEach((l) => {
      l.addEventListener("dragover", (c) => {
        c.preventDefault(), c.dataTransfer.dropEffect = "copy";
      }), l.addEventListener("drop", (c) => this.handleImageDrop(c, l));
      ...
      !c || !d || (c.dataset.action === "add-grant-member" && this.appendTemplate(d, "grant-member", ":scope > [data-grant-members]"), c.dataset.action === "add-subgroup" && this.appendTemplate(d, "grant-group", ":scope > [data-grant-members]"), c.dataset.action === "remove-row" && d.remove(), c.dataset.action === "duplicate-row" && d.after(d.cloneNode(!0)), c.dataset.action === "move-up" && d.previousElementSibling && ((u = d.parentElement) == null || u.insertBefore(d, d.previousElementSibling)), c.dataset.action === "move-down" && d.nextElementSibling && ((p = d.parentElement) == null || p.insertBefore(d.nextElementSibling, d)), this.updateStackingWarnings(e));
    }), e == null || e.addEventListener("input", (l) => {
      this.updateStackingWarnings(e);
      const c = l.target;
      c.matches("[data-image-input]") && this.updateImagePreview(e, c.name, c.value);
    }), e == null || e.querySelectorAll("[data-image-input]").forEach((l) => this.updateImagePreview(e, l.name, l.value)), (o = e == null ? void 0 : e.querySelector("[data-action='preview-player']")) == null || o.addEventListener("click", () => {
      if (!(t != null && t.reportValidity())) return;
      const l = this.previewDefinition(t);
      new M(this.deityService, { deity: l, viewer: { isGM: !1, selection: !0 } }).render(!0);
  ...
  previewDefinition(e) {
    ...
    return { ...this.readInput(e), id: "preview", schemaVersion: O, revision: 1, createdAt: t, updatedAt: t, checksum: "preview" };
  }
  populateForm(e, t, i) {
    var n, a, o, l, c;
    const r = {
  ...
  openFilePicker(e, t) {
    ...
    if (!r) return;
    const n = globalThis, a = ((u = (d = (c = n.foundry) == null ? void 0 : c.applications) == null ? void 0 : d.apps) == null ? void 0 : u.FilePicker) ?? n.FilePicker;
    if (!a) return;
    const o = (p) => {
  ...
  updateImagePreview(e, t, i) {
    ...
    if (!r) return;
    const n = i.trim();
    r.hidden = !n, n ? r.src = L(n) : r.removeAttribute("src");
  }
  readBonuses(e) {
  ...
  readAbilities(e) {
    return [...e.querySelectorAll("[data-ability-row]")].flatMap((t) => {
      ...
      if (!i) return [];
      const r = this.input(t, "ability.description"), n = this.input(t, "ability.usageMax"), a = n === "" ? null : Math.max(0, Number(n)), o = this.resetType(this.input(t, "ability.reset")), l = Math.max(0, Number(this.input(t, "ability.cooldownValue") || 0)), c = Math.max(0, Number(this.input(t, "ability.durationValue") || 0)), d = this.input(t, "ability.effectType"), u = this.input(t, "ability.formula") || "0", p = d === "heal" || d === "damage" ? [{ type: d, formula: u, target: "target" }] : d === "modifier" ? [{ type: "modifier", selector: this.input(t, "ability.selector") || "all", value: u, modifierType: "status", duration: c }] : [{ type: "message", text: r }];
      return [{
        id: crypto.randomUUID(),
        name: i,
        description: r,
  ...
  readGrantGroup(e) {
    ...
    for (const a of (t == null ? void 0 : t.children) ?? []) {
      ...
      if (!o) continue;
      const l = this.input(a, "grant.overrideName"), c = this.input(a, "grant.overrideDescription"), d = this.input(a, "grant.overrideValue"), u = Number(d), p = l || c || d ? { name: l || void 0, description: c || void 0, value: d ? Number.isFinite(u) ? u : d : void 0 } : void 0;
      i.push({ type: this.input(a, "grant.type") === "bonus" ? "bonus" : "ability", ref: o, overrides: p });
    }
  ...
  populateGrantGroup(e, t, i) {
    ...
    for (const u of i.grants) {
      ...
      m && (this.setValue(m, "grant.type", u.type), this.setValue(m, "grant.ref", u.ref), this.setValue(m, "grant.overrideName", ((l = u.overrides) == null ? void 0 : l.name) ?? ""), this.setValue(m, "grant.overrideDescription", ((c = u.overrides) == null ? void 0 : c.description) ?? ""), this.setValue(m, "grant.overrideValue", ((d = u.overrides) == null ? void 0 : d.value) === void 0 ? "" : String(u.overrides.value)), o.append(h));
    }
    t.append(n);
  }
  input(e, t) {
...
f(H, "DEFAULT_OPTIONS", { id: "darkis-godforge-deity-editor", classes: ["darkis-godforge"], window: { title: "DARKIS_GODFORGE.UI.NEW_DEITY", resizable: !0 }, position: { width: 780, height: "auto" } }), f(H, "PARTS", { main: { template: "modules/darkis-godforge/templates/deity-editor.hbs" } });
class te extends k() {
  constructor(e, t, i) {
    super(), this.deity = e, this.deityService = t, this.adapters = i;
  }
  async _prepareContext() {
    return I(), { ui: w(), deity: { ...this.deity, image: L(this.deity.image) } };
  }
  _onRender() {
    var e, t;
    (t = (e = this.element) == null ? void 0 : e.querySelector("[data-action='edit']")) == null || t.addEventListener("click", () => {
      this.deityService && new H(this.deityService, (i) => {
...
class ie extends k() {
  ...
  async _prepareContext() {
    var n, a, o;
    I();
    const e = ((a = (n = S()) == null ? void 0 : n.system) == null ? void 0 : a.id) ?? "", t = await (((o = this.adapters.tryGet(e)) == null ? void 0 : o.listOfficialDeities()) ?? Promise.resolve([])), i = this.deities.list(), r = t.map((l) => {
  ...
  _onRender() {
    ...
    e == null || e.querySelectorAll("[data-source-row]").forEach((i) => {
      ...
      for (const a of e.querySelectorAll("[data-source-row]")) {
        ...
        for (const u of this.deities.list().filter((p) => p.replacement.sourceUuid === o && p.id !== l)) this.deities.update(u.id, { replacement: { sourceUuid: "", mode: "none", contexts: [] } });
        if (l) {
...
class se extends k() {
  ...
  async _prepareContext() {
    ...
    return { ui: w(), preview: this.preview, error: this.error, deityCount: t.length, isTransfer: this.mode === "transfer", isMigration: this.mode === "migration", currentSchema: O, pendingMigrations: t.filter((i) => i.schemaVersion < O).length };
  }
  _onRender() {
    var i, r, n;
    I();
    ...
    (i = t == null ? void 0 : t.querySelector("[data-action='export']")) == null || i.addEventListener("click", () => this.downloadExport()), (r = t == null ? void 0 : t.querySelector("[data-import-file]")) == null || r.addEventListener("change", (a) => {
      ...
      var a, o, l;
      if (I(), !!this.pendingImport) {
        try {
          const c = this.readRandomContent(this.pendingImport), d = this.api.importDeities(this.pendingImport);
          c && this.randomContent.replace(c), this.pendingImport = void 0, this.preview = null, this.error = "", (l = (o = (a = N()) == null ? void 0 : a.notifications) == null ? void 0 : o.info) == null || l.call(o, `${d} ${w().IMPORTED}`);
        } catch (c) {
  ...
  async previewFile(t) {
    ...
    if (t) {
      try {
        const n = JSON.parse(await t.text()), a = Ue(n), o = new Set(this.deities.list().map((c) => c.id));
  ...
  readRandomContent(t) {
    ...
    if (!Fe(i)) throw new Error("Invalid GodForge random content.");
    return i;
  }
}
...
class ne extends k() {
  ...
  async _prepareContext() {
    var i, r;
    I();
    const e = (((r = (i = S()) == null ? void 0 : i.actors) == null ? void 0 : r.contents) ?? []).flatMap((n) => {
      var l, c;
      const a = n;
    ...
    }), t = this.deities.list().filter((n) => n.status !== "archived").map((n) => ({ id: n.id, name: n.name, choiceGroups: n.grantGroups.flatMap((a) => j(a)) }));
  ...
  _onRender() {
    ...
    t == null || t.addEventListener("change", i), i(), (r = e == null ? void 0 : e.querySelector("form")) == null || r.addEventListener("submit", (n) => {
      var u, p;
      n.preventDefault();
      const a = n.currentTarget, o = new FormData(a), l = (p = (u = S()) == null ? void 0 : u.actors) == null ? void 0 : p.get(String(o.get("actorId") ?? "")), c = String(o.get("deityId") ?? "");
      if (!l || !c) return;
      const d = {};
      e.querySelectorAll(`[data-deity-choices='${bt(c)}'] input[data-group]:checked`).forEach((h) => {
        var m;
        (d[m = h.dataset.group ?? ""] ?? (d[m] = [])).push(h.value);
      }), this.api.assignDeity(l, c, d).then(() => this.render(!0)).catch((h) => P("Character assignment failed.", h));
    });
  }
}
...
class W extends k() {
  constructor(t, i = new ce(), r = new Ve(t, i), n = new Pe()) {
    super();
    f(this, "searchTerm", "");
  ...
  async _prepareContext() {
    ...
    }), r = this.searchTerm.toLocaleLowerCase(), n = i.filter((E) => this.matchesSection(E) && (!r || `${E.name} ${E.title} ${E.domains.join(" ")}`.toLocaleLowerCase().includes(r))), a = ((p = (u = (d = S()) == null ? void 0 : d.actors) == null ? void 0 : u.contents) == null ? void 0 : p.filter(St).length) ?? 0, o = S(), l = ((m = (h = o == null ? void 0 : o.modules) == null ? void 0 : h.get("darkis-godforge")) == null ? void 0 : m.version) ?? "—", c = ((A = o == null ? void 0 : o.system) == null ? void 0 : A.id) ?? "—";
    return {
      ui: t,
      deities: n,
      ...
      systemInfo: {
        ...
        system: c,
        systemVersion: ((b = o == null ? void 0 : o.system) == null ? void 0 : b.version) ?? "—",
        moduleVersion: l,
        adapter: ((g = this.adapters.tryGet(c)) == null ? void 0 : g.id) ?? "—",
        schema: O
      }
    };
  }
  _onRender() {
    ...
    const t = this.element;
    if (!t) return;
    t.querySelectorAll("[data-action='create']").forEach((c) => c.addEventListener("click", () => new H(this.deityService, () => void this.render(!0), this.adapters).render(!0))), t.querySelectorAll("[data-action='codex']").forEach((c) => c.addEventListener("click", () => new M(this.deityService).render(!0))), t.querySelectorAll("[data-action='player-preview']").forEach((c) => c.addEventListener("click", () => new M(this.deityService, void 0, void 0, void 0, void 0, { isGM: !1, selection: !0 }).render(!0))), t.querySelectorAll("[data-section]").forEach((c) => c.addEventListener("click", () => {
      const d = c.dataset.section;
      (d === "overview" || d === "deities" || d === "pantheons" || d === "abilities" || d === "bonuses") && (this.sectionFilter = d, this.render(!0));
    })), (r = t.querySelector("[data-manager='replacements']")) == null || r.addEventListener("click", () => void new ie(this.deityService, this.adapters).render(!0)), t.querySelectorAll("[data-manager='data']").forEach((c) => c.addEventListener("click", () => {
      ...
      const d = c.dataset.managerMode, u = d === "wheels" || d === "test" ? d : "tables";
  ...
  openSettings() {
    ...
    const r = (c = (l = S()) == null ? void 0 : l.settings) == null ? void 0 : c.sheet;
    r && r.render(!0);
  }
  matchesSection(t) {
    var i;
...
class ae extends $() {
  ...
  async _prepareContext() {
    ...
    return { ui: w(), actorId: this.actor.id, ...e, deity: e.deity ? { ...e.deity, image: L(e.deity.image) } : null, abilities: e.abilities.map((t) => ({ ...t, remaining: t.uses ? Math.max(0, t.uses.max - t.uses.used) : null, available: !t.uses || t.uses.used < t.uses.max })) };
  }
  _onRender() {
    var t;
...
class vt {
  ...
  create(e) {
    const t = (/* @__PURE__ */ new Date()).toISOString(), i = { ...structuredClone(e), id: crypto.randomUUID(), schemaVersion: O, revision: 1, createdAt: t, updatedAt: t, checksum: "pending" };
...
class Tt {
  ...
  load() {
    return this.collection.contents.flatMap((e) => {
      var i;
      const t = (i = e.flags) == null ? void 0 : i[z];
  ...
  async save(e) {
    const t = this.collection.contents.find((n) => {
      var o;
      const a = (o = n.flags) == null ? void 0 : o[z];
      return a && typeof a == "object" && "deity" in a && Ee(a.deity) && a.deity.id === e.id;
    }), i = { [z]: { schemaVersion: e.schemaVersion, deity: e } };
...
function ve(s, e, t) {
  ...
  const o = R("DARKIS_GODFORGE.UI.OPEN_HUB"), l = document.createElement("a");
...
function Ct(s, e, t, i, r, n, a) {
  ...
  o && (o.Hooks.once("init", () => {
    ...
    if (!l) return;
    we(l, s, t, i, a);
    const c = ((p = (u = l.modules) == null ? void 0 : u.get(T)) == null ? void 0 : p.languages) ?? [{ lang: "de", name: "Deutsch" }, { lang: "en", name: "English" }], d = Object.fromEntries([["auto", "DARKIS_GODFORGE.SETTINGS.AUTO"], ...c.map((h) => [h.lang, h.name])]);
    if (!l.settings) console.error("Darkis GodForge | game.settings is unavailable during init.");
      ...
      if (!l.settings.registerMenu) console.error("Darkis GodForge | game.settings.registerMenu is unavailable during init.");
        ...
        l.settings.registerMenu(T, "dashboard", { name: "DARKIS_GODFORGE.SETTINGS.MENU_NAME", label: "DARKIS_GODFORGE.SETTINGS.MENU_LABEL", hint: "DARKIS_GODFORGE.SETTINGS.MENU_HINT", icon: "fas fa-hammer", type: _t(e, s, n), restricted: !0 });
      } catch (h) {
        console.error("Darkis GodForge | Could not register dashboard settings menu.", h);
      }
      try {
        l.settings.register(T, "language", { name: "DARKIS_GODFORGE.SETTINGS.LANGUAGE", hint: "DARKIS_GODFORGE.SETTINGS.LANGUAGE_HINT", scope: "client", config: !0, type: String, default: "auto", choices: d, onChange: (h) => {
          if (typeof h != "string" || h === "auto") return;
          const m = c.find((A) => A.lang === h);
          m != null && m.path && Ie(h, `modules/${T}/${m.path}`);
        } });
      } catch (h) {
        console.error("Darkis GodForge | Could not register language setting.", h);
      }
      try {
        l.settings.register(T, "random-content", { scope: "world", config: !1, type: Object, default: { tables: [], wheels: [] } });
      } catch (h) {
    ...
    if (!l.keybindings) console.error("Darkis GodForge | game.keybindings is unavailable during init.");
      ...
      l.keybindings.register(T, "open-dashboard", { name: "DARKIS_GODFORGE.UI.OPEN_DASHBOARD", editable: [], onDown: () => {
        var h, m;
        return ((m = (h = S()) == null ? void 0 : h.user) == null ? void 0 : m.isGM) !== !0 ? !1 : (t(), !0);
      } }), l.keybindings.register(T, "open-hub", { name: "DARKIS_GODFORGE.UI.OPEN_HUB", editable: [{ key: "KeyG" }], restricted: !1, onDown: () => (a == null || a(), !0) }), l.keybindings.register(T, "open-codex", { name: "DARKIS_GODFORGE.UI.OPEN_CODEX", editable: [{ key: "KeyG", modifiers: ["Shift"] }], restricted: !1, onDown: () => (i(), !0) });
    } catch (h) {
      console.error("Darkis GodForge | Could not register keybindings.", h);
    }
  }), o.Hooks.on("getSceneControlButtons", (...l) => {
    var c, d;
    Nt(l[0], t, i, ((d = (c = S()) == null ? void 0 : c.user) == null ? void 0 : d.isGM) === !0, () => a == null ? void 0 : a());
  }), o.Hooks.on("renderCharacterSheetPF2e", (l, c) => {
    a && ve(l, c, a);
  }), o.Hooks.on("renderActorSheet", (l, c) => {
    a && ve(l, c, a);
  }), o.Hooks.once("ready", async () => {
    var c, d, u, p, h, m, A, b, g, E;
    const l = Te("ready");
    if (l) {
      we(l, s, t, i, a);
      try {
        const y = (d = (c = l.settings) == null ? void 0 : c.get) == null ? void 0 : d.call(c, T, "language"), D = (h = (p = (u = l.modules) == null ? void 0 : u.get(T)) == null ? void 0 : p.languages) == null ? void 0 : h.find((He) => He.lang === y);
        typeof y == "string" && (D != null && D.path) && await Ie(y, `modules/${T}/${D.path}`);
      } catch (y) {
        console.error("Darkis GodForge | Could not load the selected language.", y);
      }
      try {
        if (l.journal) {
          const y = new Tt(l.journal);
      ...
      try {
        if (n) {
          const y = (A = (m = l.settings) == null ? void 0 : m.get) == null ? void 0 : A.call(m, T, "random-content");
          n.load(y && typeof y == "object" ? y : null), (b = l.settings) != null && b.set && n.setPersistence((D) => l.settings.set(T, "random-content", D));
        }
      } catch (y) {
        console.error("Darkis GodForge | Could not load random content.", y);
      }
      try {
        const y = wt((E = (g = l.modules) == null ? void 0 : g.get("socketlib")) == null ? void 0 : E.api);
...
function we(s, e, t, i, r) {
  var o;
  const n = (o = s.modules) == null ? void 0 : o.get(T);
  if (!n) {
...
const K = new vt(), fe = new ce(), V = new Ve(K, fe), xe = new Pe();
let De = null;
function Oe() {
  if (!pe()) {
    me();
  ...
  De ?? (De = new W(K, fe, V, xe)), De.render(!0).catch((s) => {
    var e, t, i;
    console.error("Darkis GodForge | Could not open dashboard.", s), (i = (t = (e = N()) == null ? void 0 : e.notifications) == null ? void 0 : t.error) == null || i.call(t, R("DARKIS_GODFORGE.ERROR.DASHBOARD_OPEN"));
  });
}
function qe() {
  new M(K, void 0, V, ge, Be()).render(!0).catch((e) => {
    var t, i, r;
    console.error("Darkis GodForge | Could not open codex.", e), (r = (i = (t = N()) == null ? void 0 : t.notifications) == null ? void 0 : i.error) == null || r.call(i, R("DARKIS_GODFORGE.ERROR.CODEX_OPEN"));
  });
}
...
function Gt(s) {
  ...
  const e = s ?? Be();
  if (!e) {
    (n = (r = (i = N()) == null ? void 0 : i.notifications) == null ? void 0 : r.warn) == null || n.call(r, R("DARKIS_GODFORGE.UI.SELECT_CHARACTER_FIRST"));
    return;
  }
  let t = Re.get(e.id);
  t || (t = new ae(e, V, ge, qe), Re.set(e.id, t)), t.render(!0).catch((a) => {
    var o, l, c;
    console.error("Darkis GodForge | Could not open hub.", a), (c = (l = (o = N()) == null ? void 0 : o.notifications) == null ? void 0 : l.error) == null || c.call(l, R("DARKIS_GODFORGE.ERROR.HUB_OPEN"));
  });
}
const _e = oe(), ge = new kt(V, { get currentUserId() {
  var s, e;
  return ((e = (s = S()) == null ? void 0 : s.user) == null ? void 0 : e.id) ?? "unknown";
}, get isGM() {
  var s, e;
  return ((e = (s = S()) == null ? void 0 : s.user) == null ? void 0 : e.isGM) ?? !1;
}, isGMUser: (s) => {
  var e, t, i;
  return ((i = (t = (e = S()) == null ? void 0 : e.users) == null ? void 0 : t.get(s)) == null ? void 0 : i.isGM) === !0;
}, ownsActor: (s, e) => {
  var i, r, n;
  const t = ((r = (i = S()) == null ? void 0 : i.users) == null ? void 0 : r.get(e)) ?? { id: e };
  return ((n = s.testUserPermission) == null ? void 0 : n.call(s, t, "OWNER")) ?? !1;
}, resolveActor: (s) => {
  var e, t;
  return ((t = (e = S()) == null ? void 0 : e.actors) == null ? void 0 : t.get(s)) ?? null;
} });
_e ? (Ct(V, K, Oe, qe, ge, xe, Gt), _e.Hooks.once("ready", () => {
  var e, t, i, r, n;
  const s = (t = (e = S()) == null ? void 0 : e.system) == null ? void 0 : t.id;
  s && !fe.supports(s) && ((n = (r = (i = N()) == null ? void 0 : i.notifications) == null ? void 0 : r.warn) == null || n.call(r, R("DARKIS_GODFORGE.ERROR.UNSUPPORTED_SYSTEM").replace("{system}", s)));
...
function Be() {
  ...
  return e.length === 1 ? e[0] : (n = (r = S()) == null ? void 0 : r.user) == null ? void 0 : n.character;
}
export {
