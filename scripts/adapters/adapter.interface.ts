...
export interface GodForgeSystemAdapter { readonly id: string; readonly capabilities: AdapterCapabilities; materialize(deity: DeityDefinition, context?: MaterializationContext): Promise<string | null>; buildPassiveBonus(bonus: DeityDefinition["passiveBonuses"][number]): object | null; buildClassCoupling(result: ClassGrantResult): object | null; }
