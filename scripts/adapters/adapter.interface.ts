...
export interface SystemChoice { value: string; label: string; slug?: string; img?: string; group?: string; category?: string; traits?: string[]; source?: string; rank?: number; remaster?: boolean; available?: boolean; details?: string; }
