...
export interface FoundryRuntime { Hooks: FoundryHooks; game?: { user?: { id?: string; isGM?: boolean }; system?: { id?: string }; journal?: FoundryJournalCollection; settings?: { register(namespace: string, key: string, config: Record<string, unknown>): void }; keybindings?: { register(namespace: string, key: string, config: Record<string, unknown>): void }; modules?: { get(id: string): { api?: unknown } | undefined } }; }
